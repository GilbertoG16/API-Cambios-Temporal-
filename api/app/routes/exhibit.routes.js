...
const verifyCreateExhibit = require("../middleware/verifyCreateExhibit");
...
module.exports = function(app){
    app.use(function(req, res, next) {
      ...
      app.put(
        "/api/crud/updateExhibit/:exhibitID", //Ruta PUT para hacer update de registro de exhibición
        [
          authJwt.verifyToken,
          authJwt.isAdmin,
      ...
      app.post(
        "/api/crud/createExhibit", //Ruta POST para crear registro de exhibición
       [
        authJwt.verifyToken,
        authJwt.isAdmin,
